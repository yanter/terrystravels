		...
		schema: {
			...
			content: fields.mdx({
				...
				components: {
					...
					AffiliateLink: ComponentBlocks.AffiliateLink(`src/data/blog/${locale}/`, locale),
				},
			}),
		},
	});
		...
		schema: {
			...
			content: fields.mdx({
				...
				components: {
					Admonition: ComponentBlocks.Admonition,
					Newsletter: ComponentBlocks.Newsletter,
					// I wouldn't recommend using this component in "otherPages" and it might not work correctly
					// I just have it here so things can build and I can show off the afiliate link component
					AffiliateLink: ComponentBlocks.AffiliateLink(`src/data/otherPages/${locale}/`, locale),
				},
			}),
		},
	});
